...
class ChatRequest(BaseModel):
    ...
    retrieval_strategy: Optional[Literal["vector", "hybrid", "mmr", "multi_query", "graph", ""]] = Field(
        "",
        description="检索策略: vector-向量检索, hybrid-混合检索, mmr-最大边际相关性, multi_query-多查询检索, graph-知识图谱检索, 空字符串-不使用检索"
    )
